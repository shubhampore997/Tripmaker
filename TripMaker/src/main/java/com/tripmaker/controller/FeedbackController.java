...
import com.tripmaker.service.FeedbackServiceImp;
...
public class FeedbackController {
	...
	@PostMapping("/Feedback/add/{customerId}")
	...
	public ResponseEntity<List<Feedback>> findByCustomerId(@PathVariable("customerId") Integer userId) throws FeedbackException
	{
